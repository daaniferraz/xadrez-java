...
public class UI {
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		...
		try {
			...
			throw new InputMismatchException("Erro ao Instanciar Chessposition. Valor valido é de a1 até h8");
		}
	}
	...
	private static void printPiece(ChessPiece piece,boolean backgrond) {
		if (backgrond) {
